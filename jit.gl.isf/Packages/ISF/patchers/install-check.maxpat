...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 618.0, 458.0, 75.0, 22.0 ],
					"text" : "offset 0 -150"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 555.0, 458.0, 58.0, 22.0 ],
					"text" : "offset 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 555.0, 490.0, 67.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 477.0, 278.826629638671875, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 681.0, 416.27801513671875, 71.0, 22.0 ],
					"text" : "sel success"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 681.0, 387.71563720703125, 63.0, 22.0 ],
					"text" : "route start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 555.0, 201.90911865234375, 52.0, 22.0 ],
					"text" : "platform"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "bang", "" ],
					"patching_rect" : [ 555.0, 249.90911865234375, 107.0, 22.0 ],
					"text" : "sel mac windows"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 762.0, 397.5, 29.5, 22.0 ],
					"text" : "$1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "bang", "" ],
					"patching_rect" : [ 555.0, 426.40911865234375, 79.0, 22.0 ],
					"text" : "sel Error: ISF"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 555.0, 393.5, 55.0, 22.0 ],
					"text" : "strippath"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 555.0, 278.235748291015625, 161.0, 22.0 ],
					"text" : "cd /Library/Graphics/ISF/"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 599.0, 309.71563720703125, 121.0, 22.0 ],
					"text" : "cd /ProgramData/ISF"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 477.0, 315.5623779296875, 64.0, 22.0 ],
					"text" : "script start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 555.0, 225.90911865234375, 44.0, 22.0 ],
					"saved_object_attributes" : 					{
						"selector" : "platform"
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 555.0, 356.0623779296875, 145.0, 22.0 ],
					"saved_object_attributes" : 					{
						"autostart" : 0,
						"defer" : 0,
						"watch" : 0
...
, 			{
				"box" : 				{
					...
					"spacing_x" : 12.0,
					"spacing_y" : 14.0,
					"tabcolor" : [ 0.984313725490196, 0.486274509803922, 0.501960784313725, 1.0 ],
					"tabs" : [ "Download ISF" ],
...
, 			{
				"box" : 				{
					...
					"textcolor" : [ 1.0, 0.0, 0.032541817489994, 1.0 ],
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.166656494140625, 1.5, 452.704536437988281, 35.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.462120056152344, 383.801498413085938, 391.704536437988281, 195.215240478515625 ],
					"proportion" : 0.5,
					"rounded" : 2
				}
...
, 			{
				"box" : 				{
					"angle" : 270.0,
					"background" : 1,
					"bgcolor" : [ 0.607843137254902, 0.992156862745098, 0.568627450980392, 1.0 ],
					"bordercolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"id" : "obj-9",
					"maxclass" : "panel",
					"mode" : 0,
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.166656494140625, 151.5, 452.704536437988281, 35.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 2.166656494140625, 148.5, 391.704536437988281, 195.215240478515625 ],
					"proportion" : 0.5,
					"rounded" : 2
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 690.5, 484.5, 817.0, 484.5, 817.0, 196.5, 564.5, 196.5 ],
					"source" : [ "obj-127", 0 ]
				}
