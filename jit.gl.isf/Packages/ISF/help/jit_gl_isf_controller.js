...
function anything()	{
	...
	if (a[0] == "getparamlist")	{
		...
		if (inputBPatcher != null)	{
			this.patcher.disconnect(this.patcher.getnamed("jit_gl_isf_controller"), 1, inputBPatcher, 0);
		}
		...
		this.patcher.hiddenconnect(this.patcher.getnamed("jit_gl_isf_controller"), 1, inputBPatcher, 0);
